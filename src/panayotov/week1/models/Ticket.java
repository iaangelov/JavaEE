...
@XmlRootElement
@Table(name = "T_TICKET")
@JsonIdentityInfo(generator = ObjectIdGenerators.IntSequenceGenerator.class, property = "@ticketd")
@NamedQueries({
		...
		@NamedQuery(name = QueryNames.Ticket_FindByUser, query = "SELECT t FROM Ticket t WHERE t.user.username = :username")})
